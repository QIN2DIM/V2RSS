...
# ActionHuoXingCloud
# - change log:
#   -2021-11-18 [Create] 更新实例
#   -2021-11-18 [1day 1G + 100 * 2G co-invite]
# =============================================
ActionHuoXingCloud = {
...
# - change log:
#   -2021-11-18 [Create] 更新实例
#   -2021-11-18 [1day 0G + 30 * 2 co-invite]
# =============================================
ActionJcBbCloud = {
...
# - change log:
#   -2021-11-18 [Create] 更新实例
#   -2021-11-18 [14day 60G + 10 * 2 co-invite]
# =============================================
ActionMfCloud = {
    "name": "ActionMfCloud",
...
#   - 2021-11-19 [1day 1G + 10 * 20G co-invite]
# =============================================
ActionPPCloud = {
    "name": "ActionPPCloud",
...
# ActionSuFeiCloud
# - change log:
#   - 2020-06-16 可用流量1024MB不满足标准
#   - 2021-11-19 [2day 1G + 10 * 2G = 20G]
# =============================================
ActionSuFeiCloud = {
...
# - intro: 1day 10G
# - change log:
#   - 2021-11-19 [1day 0G + 10 * 5G co-invite]
# =============================================
ActionReCloud = {
    "name": "ActionReCloud",
...
# ActionFeiSuCloud
# - change log:
#   - 2021-06-16 jdycloud.xyz
#   - 2021-12-15 [N day 2G + 1000 * 0.1G co-invite]
# =============================================
ActionFeiSuCloud = {
    "name": "ActionShanSuCloud",
    "register_url": "https://feisucloud.pw/auth/register",
    "nest": "sspanel",
    "hyper_params": {"v2ray": True, "anti_slider": True},
    "email": "@qq.com",
    "life_cycle": 30,
...
# =============================================
ActionXFssCloud = {
    "name": "ActionXFssCloud",
    "register_url": "https://xfss.cc/#/register",
    "nest": "v2board",
    "hyper_params": {"anti_email": True},
    "life_cycle": 24 * 7,
}
