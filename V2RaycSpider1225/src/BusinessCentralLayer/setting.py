...
# 声纹验证缓存
SERVER_DIR_CACHE_AUDIO = join(SERVER_DIR_DATABASE_CACHE, "audio_cache")

# 运行缓存:采集器输出目录
SERVER_DIR_STORE_COLLECTOR = join(SERVER_DIR_DATABASE, "sspanel_hosts")

# 运行缓存:分类器输出目录
SERVER_DIR_OUTPUT_STORE_CLASSIFIER = join(SERVER_DIR_STORE_COLLECTOR, "classifier")
...
for _pending in [
    SERVER_DIR_DATABASE,
    SERVER_DIR_STORE_COLLECTOR, SERVER_DIR_OUTPUT_STORE_CLASSIFIER,
    SERVER_DIR_DATABASE_CACHE,SERVER_DIR_CACHE_BGPIC,SERVER_DIR_CACHE_AUDIO
]:
