...
from src.BusinessCentralLayer.setting import SMTP_ACCOUNT, SERVER_CHAN_SCKEY, logger, SERVER_DIR_DATABASE_LOG
...
def _load_recent_log(mod: str = 'default', log_path: str = None):
    """
